...
- FP16 activations and INT2, INT4 or INT8 weights,
...
- `N % (bits==8 ? 32 : bits==4 ? 64 : 128) == 0`, `K % block_size == 0`, and `sm_ >= 75`,
...
matrix. Full mode additionally supports BF16, `block_size=128`, `block_size=64`
for 4/8-bit, zero-points, bias, and the native SM90 layout
