...
if [ "$ENABLE_DUMP" = "ON" ]; then
    ...
    export ORT_DEBUG_NODE_IO_SNIPPET_EDGE_ITEMS=100
    export ORT_DEBUG_NODE_IO_DUMP_STATISTICS_DATA=0
    export ORT_TENSOR_SNIPPET_THRESHOLD=0
    export ORT_TENSOR_SNIPPET_EDGE_ITEMS=100
else
