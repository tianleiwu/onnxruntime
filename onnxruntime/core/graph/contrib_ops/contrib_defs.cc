...
ONNX_MS_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("quant_type",
              ...
              "'fp8' for FP8 e4m3 weight-only quantization, 'w4afp8' for INT4 weight with FP8 activation, "
        ...
        .Input(3,
               ...
               "For quant_type='fp4' or 'wfp4afp8', this is a uint8 MXFP block-scale tensor with shape "
        ...
        .Input(20,
               "fc1_act_block_scale",
               "3D optional uint8 MXFP activation block-scale tensor for FC1 FP8 activation modes.",
               "T2",
               OpSchema::Optional)
        .Input(21,
               "fc2_act_block_scale",
               "3D optional uint8 MXFP activation block-scale tensor for FC2 FP8 activation modes.",
               "T2",
               OpSchema::Optional)
        .Output(0,
                "output",
