...
#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UZILHFD(x) \
  ...
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL(x, __nv_bfloat16)
...
#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_T1_ILHFD(x, T) \
  ...
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL_T1(x, T, __nv_bfloat16)
...
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_T1_ILHFD(Pow, __nv_bfloat16)
...
#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UZILHFD2(name)               \
  ...
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL_T2(name, bool, __nv_bfloat16, __nv_bfloat16)
