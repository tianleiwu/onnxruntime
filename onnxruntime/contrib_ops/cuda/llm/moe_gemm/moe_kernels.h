...
struct MoeRoutePolicy {
  ...
  static MoeRoutePolicy GemvWhereSupported() {
    return {MoeFcRoute::kGemv, MoeFcRoute::kGemv};
  }

  static MoeRoutePolicy Fc1GemvFc2Gemm() {
    return {MoeFcRoute::kGemv, MoeFcRoute::kGroupedGemm};
  }

  static MoeRoutePolicy Fc1GemmFc2Gemv() {
    return {MoeFcRoute::kGroupedGemm, MoeFcRoute::kGemv};
  }
};
...
class CutlassMoeFCRunner : public CutlassMoeFCRunnerInterface {
 ...
 public:
  ...
  void gemm1(void const* const input, void* const output, void* const intermediate_result,
    ...
    return Self::gemm1(moe_gemm_runner_, static_cast<T const*>(input),
...
struct GemmProfilerBackend {
 public:
  ...
  void runProfiler(int num_tokens, cutlass_extensions::CutlassGemmConfig const& tactic, char* workspace_ptr_char, void const* expert_weights,
