    ...
    {                                                                                                                                                                                                                                             \
        ...
        {                                                                                                                                                                                                                                         \
            ...
            constexpr static bool IsFP8 = cutlass::platform::is_same<T, SafeFP8>::value;                                                                                                                                                          \
                                                                                                                                                                                                                                                  \
            constexpr static bool IsWFP8A16 = cutlass::platform::is_same<WeightType, SafeFP8>::value                                                                                                                                              \
                && (cutlass::platform::is_same<T, half>::value || cutlass::platform::is_same<T, SafeBF16>::value);                                                                                                                                \
                                                                                                                                                                                                                                                  \
            static_assert(cutlass::platform::is_same<T, WeightType>::value || IsWFP4AFP8 || IsWFP8A16,                                                                                                                                            \
            ...
            using ElementABlockScaled                                                                                                                                                                                                             \
                = std::conditional_t<IsSM120, std::conditional_t<IsWFP4AFP8, cutlass::mx_float8_t<ElementA>, cutlass::nv_float4_t<ElementA>>, cute::tuple<ElementA, ElementSF>>;                                                                  \
            using ElementBBlockScaled                                                                                                                                                                                                             \
                = std::conditional_t<IsSM120, std::conditional_t<IsWFP4AFP8, cutlass::mx_float4_t<ElementB>, cutlass::nv_float4_t<ElementB>>, cute::tuple<ElementB, ElementSF>>;                                                                  \
                                                                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                                                                         \
            ORT_THROW("Configuration was disabled by ORT_QUICK_BUILD");                                                                                                                                                                               \
        }                                                                                                                                                                                                                                         \
                                                                                                                                                                                                                                                  \
        return;                                                                                                                                                                                                                                   \
    }                                                                                                                                                                                                                                             \
