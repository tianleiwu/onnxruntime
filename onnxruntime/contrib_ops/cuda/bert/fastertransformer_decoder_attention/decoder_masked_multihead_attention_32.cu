...
template void mmha_launch_kernel<float, BFloat16, 32>(const DecoderMaskedMultiHeadAttentionParameters&, cudaStream_t stream);
template void mmha_launch_kernel<uint16_t, BFloat16, 32>(const DecoderMaskedMultiHeadAttentionParameters&, cudaStream_t stream);

template void mmha_launch_kernel<float, __nv_bfloat16, 32>(const DecoderMaskedMultiHeadAttentionParameters&, cudaStream_t stream);
template void mmha_launch_kernel<uint16_t, __nv_bfloat16, 32>(const DecoderMaskedMultiHeadAttentionParameters&, cudaStream_t stream);
