...
Status CheckInputs(MoEParameters& parameters,
                   ...
                   const Tensor* fc1_zero_points,      // optional, new for qMoE
                   ...
                   const Tensor* fc2_zero_points,      // optional, new for qMoE
                   ...
                   const Tensor* fc3_zero_points,      // optional, new for qMoE
  ...
  if (fc3_experts_weights == nullptr) {
    ...
    ORT_ENFORCE(fc1_zero_points == nullptr || fc3_zero_points != nullptr);        // MOE no zp, or qMOE need zps
  }
