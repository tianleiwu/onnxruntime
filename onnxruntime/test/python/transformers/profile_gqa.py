...
def create_gqa_config(
    ...
    """Create a GQA config based on the mode (fp16, bf16)."""
...
def run_comparison(args):
    ...
    modes = ["fp16", "bf16"] if args.mode == "all" else [args.mode]
    results = {}
...
def main():
    ...
    parser.add_argument("--mode", choices=["fp16", "bf16", "all"], default="all", help="Quantization mode to test")
