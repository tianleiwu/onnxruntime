...
Usage:
  ...
  python parse_gqa_nsys.py gqa_int8.sqlite
  python parse_gqa_nsys.py gqa_int8.sqlite --output results.json
  python parse_gqa_nsys.py gqa_int8.sqlite --format csv --output results.csv
"""
