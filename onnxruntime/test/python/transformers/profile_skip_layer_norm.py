...
Usage:
  ...
  # With TRT-LLM shmem kernel variant:
  nsys profile -e ORT_SKIP_LAYER_NORM_USE_SHMEM_KERNEL=1 -o sln_shmem --export=sqlite \
      python profile_skip_layer_norm.py --mode fp16 --warmup 5 --repeat 100
  python parse_nsys.py sln_shmem.sqlite --skip-first 5
"""
...
def run_profiling(args):
    ...
    use_shmem = os.environ.get("ORT_SKIP_LAYER_NORM_USE_SHMEM_KERNEL", "0")
    print(f"        ORT_SKIP_LAYER_NORM_USE_SHMEM_KERNEL={use_shmem}")
    print(f"{'=' * 70}\n")
