...
# Flash build mode:
#   - We keep only hdim128 flash attention kernels in flash build mode.
...
elseif(onnxruntime_FLASH_BUILD)
  message(STATUS "Flash build mode enabled: Only building hdim128 flash attention kernels")
  list(FILTER onnxruntime_cuda_contrib_ops_cu_srcs EXCLUDE REGEX "flash_fwd.*hdim(32|64|96|192|256)")
endif()
