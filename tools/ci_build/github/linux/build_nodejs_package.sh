...
# The $CUDA_VERSION is set by the Azure pipeline (common-variables.yml called by nodejs-linux-packaging-stage.yml).
...
--use_webgpu --use_tensorrt --cuda_version=$CUDA_VERSION --cuda_home=/usr/local/cuda-$CUDA_VERSION --cudnn_home=/usr --tensorrt_home=/usr \
